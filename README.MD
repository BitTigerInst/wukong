...
4. Clone wukong from github: ` $ git clone https://github.com/BitTigerInst/wukong.git `
5. Go into wukong forlder and install node package: ` cd wukong && npm install `
6. Run wukong: ` node index `
